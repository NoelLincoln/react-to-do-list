...
<div align="center">
  ...
  <h3><b>React To Do List Application</b></h3>
...
**To do list** is an application built using React and Vite
.
...
```sh
  cd my-folder
  git clone https://github.com/NoelLincoln/to-do-list-vite.git
```
...
Feel free to check the [issues page](https://github.com/NoelLincoln/to-do-list-vite.git/issues).
